...
export function Timeline({ data }: ITimelineProps) {
  return (
    <div className='flex relative border-cgreen-4 border-4 rounded-[42px] px-2 py-4 md:px-4 md:py-8'>
      <div className='h-auto w-20 bg-gradient-to-r from-cgreen-5 to-transparent z-10 absolute left-2 md:left-4 top-4 bottom-4' />
      <div className='h-auto w-20 bg-gradient-to-l from-cgreen-5 to-transparent z-10 absolute right-2 md:right-4 top-4 bottom-4' />
